...
echo "\033[0;35m+ nodeos is producing blocks!\033[0m"
...
echo ""
echo "\033[0;35m+ nodeos is answering correctly!\033[0m"

echo ""
echo "\033[0;34m+++ /!\ The blockchain has started! /!\ +++\033[0m"
...
echo ""
echo "\033[0;35m+ setup wallet eosiomain\033[0m"
...
echo ""
echo "\033[0;35m+ setup wallet beancoin\033[0m"
...
echo ""
echo "\033[0;35m+ deploy the smart contract\033[0m"
...
echo ""
echo "\033[0;35m+ downloading jq (json reader) to create mock data\033[0m"
...
echo ""
echo "\033[0;35m+ create mock accounts\033[0m"
jq -c '.[]' mock.accounts.json | while read i; do
  name=$(jq -r '.name' <<< "$i")
...
echo ""
echo "\033[0;35m+ create mock data\033[0m"
